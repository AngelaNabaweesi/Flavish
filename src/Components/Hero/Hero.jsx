  ...
  return (
    <div className='hero container'>
        <div className="hero-text">
            <h1>Flavish - Elevating Every Occasion</h1><br/>
            <a href="#contact"><button className='btn'>Place Order <img src={dark_arrow}/></button></a><br/>
            <p>Welcome to Flavish, where elegance meets thoughtfulness in every gift, floral arrangement, and decor piece. Life may be demanding, 
